 ...
 *
 * _coder_systolicAverageMax_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "systolicAverageMax",                /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  static const int32_T dims[1] = { 27623 };
...
void systolicAverageMax_api(const mxArray * const prhs[1], int32_T nlhs, const
  mxArray *plhs[2])
{
  emxArray_real_T *b_signal;
  real_T estimateValue;
  real_T val;
  ...
  emxInit_real_T(&st, &b_signal, 1, true);
  ...
  plhs[0] = emlrt_marshallOut(estimateValue);
  emxFree_real_T(&b_signal);
  if (nlhs > 1) {
    plhs[1] = emlrt_marshallOut(val);
  }

  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

void systolicAverageMax_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  systolicAverageMax_xil_terminate();
  systolicAverageMax_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void systolicAverageMax_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void systolicAverageMax_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_systolicAverageMax_api.c) */
